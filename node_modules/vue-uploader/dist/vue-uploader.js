 ...
 * Vue-uploader 0.1.2
 * (c) Peak Tai
 * Wed Jul 06 2016 19:37:59 GMT+0800 (CST)
 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uploader = __webpack_require__(69);
	...
	exports.install = function (Vue, options) {
	    options = options || {};
	    var component = Vue.extend(_uploader2.default);
	    var name = options.name || "vue-uploader";
	    //对压缩参数进行判断
	    if ((0, _typeof3.default)(options.compress) == 'object' && (0, _util.validateCompress)(options.compress)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/uploader.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-bbaed2be/uploader.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".vue-uploader {\n  overflow: hidden;\n}\n.vue-uploader button {\n  display: inline-block;\n  border: 1px solid #eeeeee;\n  color: #333333;\n  padding: 5px 10px;\n  background-color: white;\n  border-radius: 4px;\n  cursor: pointer;\n}\n.vue-uploader button[disabled],\n.vue-uploader button .disabled {\n  opacity: 0.65;\n  cursor: not-allowed;\n}\n.vue-uploader table {\n  width: 100%;\n}\n.vue-uploader table tbody tr td {\n  padding: 8px;\n  border-bottom: 1px solid #eee;\n}\n.vue-uploader table tbody tr:first-child td {\n  border-top: 1px solid #eee;\n}\n.vue-uploader .thumbnail {\n  height: 50px;\n  width: 50px;\n  overflow: hidden;\n}\n.vue-uploader .thumbnail img {\n  height: 50px;\n  margin-left: 50%;\n  -webkit-transform: translateX(-50%);\n          transform: translateX(-50%);\n}\n.vue-uploader .success {\n  color: #3c763d;\n}\n.vue-uploader .error {\n  color: #d9534f;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UploadFile = __webpack_require__(79);
	...
	exports.default = {
	    props: {
	        ...
	        compress: {
	            type: Object,
	            validator: function validator(val) {
	                return (0, _util.validateCompress)(val);
	            }
	            //              {
	            //                  //压缩后的最大宽度
	            //                  width: 1600,
	    ...
	    computed: {
	        ...
	        overview: function overview() {
	            return "一共" + this.list.length + "个文件," + (0, _filters.sizeConvert)(this.totalSize);
	        },
	    ...
	    methods: {
	        ...
	        add: function add(e) {
	            ...
	            for (var i = 0; i < files.length; i++) {
	                ...
	                if (file.size > component.sizeLimit) {
	                    alert("单个文件不得超过" + (0, _filters.sizeConvert)(component.sizeLimit));
	                    return;
	                }
	            ...
	            for (var _i = 0; _i < files.length; _i++) {
	                var _file = files[_i];
	                var uploadFile = new _UploadFile2.default(_file);
	        ...
	        isFileExist: function isFileExist(uf) {
	            for (var i = 0; i < this.list.length; i++) {
	        ...
	        //删除已完成
	        removeFinished: function removeFinished() {
	            var arr = [];
	            this.list.forEach(function (uf) {
	        ...
	        checkExtension: function checkExtension(fileName) {
	            return !this.extensions.length || this.extensions.includes((0, _util.getExtension)(fileName));
	        }
	    },
	    filters: { sizeConvert: _filters.sizeConvert, trancateHead: _filters.trancateHead, trancateTail: _filters.trancateTail, percentage: _filters.percentage }
	};
	// </script>
...
/***/ function(module, exports) {
	...
	var sizeConvert = exports.sizeConvert = function sizeConvert(val) {
	    var result = "";
	    var megabyte = val / (1024 * 1024);
	    if (megabyte >= 1) {
	        result = megabyte.toFixed(2);
	        return (/^\d+\.00$/.test(result) ? megabyte.toFixed(0) + "M" : result + "M"
	        );
	    }
	    var kilobyte = val / 1024;
	    result = kilobyte.toFixed(2);
	    return (/^\d+\.00$/.test(result) ? kilobyte.toFixed(0) + "K" : result + "K"
	    );
	};
	var trancateHead = exports.trancateHead = function trancateHead(val) {
	    if (val.length <= 15) {
	        return val;
	    }
	...
	var trancateTail = exports.trancateTail = function trancateTail(val) {
	    if (val.length <= 15) {
	        return val;
	    }
...
/***/ function(module, exports) {
	 ...
	 */
	var validateCompress = exports.validateCompress = function validateCompress(compress) {
	    if (compress.height && (isNaN(compress.height) || compress.height <= 0)) {
	        console.warn("compress.height is invalid");
	        return false;
	    }
	    if (compress.width && (isNaN(compress.width) || compress.width <= 0)) {
	        console.warn("compress.width is invalid");
	        return false;
	    }

	    if (compress.quality && (isNaN(compress.quality) || compress.quality <= 0 || compress.quality > 100)) {
	        console.warn("compress.quality must between 0 and 100");
	        return false;
	    }
	    return true;
	};

	var getExtension = exports.getExtension = function getExtension(fileName) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UploadFile = function () {
	    ...
	    function UploadFile(file) {
	        ...
	        this.type = file.type;
	        this.size = file.size;
	        this.hr_size = (0, _filters.sizeConvert)(file.size);
	        this.status = "ready";
	        this.progress = 0;
	        this.extension = (0, _util.getExtension)(file.name);
	        this.thumbnail = null;
	        this.origin = file;
	    }
	    ...
	    (0, _createClass3.default)(UploadFile, [{
	        key: "makeThumbnail",
	        value: function makeThumbnail(calback) {
	            var uploadFile = this;
	            if (!uploadFile.type || !uploadFile.type.indexOf("image") == 0) {
	                return;
	            }
	            (0, _lrzAll2.default)(uploadFile.origin, { height: 50, quality: 90 }).then(function (res) {
	        ...
	        value: function start() {
	            ...
	            var xhr = uf.xhr = new XMLHttpRequest();
	            ...
	            var compress = uf._vm.compress || uf._vm.default_compress;
	            if (compress && uf.type && uf.type.indexOf("image/") == 0) {
	                //compress
	                (0, _lrzAll2.default)(uf.origin, compress).then(function (rst) {
